...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_name', 'description' => 'St. Mark School'],
            ['type' => 'term_ends', 'description' => '7/10/2025'],
            ['type' => 'term_begins', 'description' => '9/9/2024'],
            ['type' => 'phone', 'description' => '0911000000'],
            ['type' => 'address', 'description' => 'Addis Ababa, Ethiopia'],
            ['type' => 'system_email', 'description' => 'info@stmarksms.com'],
